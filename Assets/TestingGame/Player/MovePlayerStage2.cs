...
public class MovePlayerStage2 : MonoBehaviour {
    ...
    void Update()
    {
        if (ScoreTStage2.ScoreStage2 >= 2000 && BonusActiv == false)
        {
